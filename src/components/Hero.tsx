...
const Hero = () => {
  return (
    <section 
      ...
      className="relative min-h-screen flex items-start md:items-center justify-center pt-8 md:pt-24 overflow-hidden"
    >
      {/* Background pattern */}
      ...
      <div className="absolute top-1/4 left-1/4 w-3 h-3 rounded-full bg-white border-2 border-gray-200" aria-hidden="true"></div>
      <div className="absolute bottom-1/4 right-1/4 w-3 h-3 rounded-full bg-white border-2 border-gray-200" aria-hidden="true"></div>
      <div className="absolute top-1/3 right-1/3 w-3 h-3 rounded-full bg-white border-2 border-gray-200" aria-hidden="true"></div>
      ...
      <div className="relative z-10 w-full max-w-[1200px] mx-auto px-4 sm:px-6 text-center mt-12 md:mt-0">
        ...
        <Link 
          to="/review-contract"
          className="inline-flex items-center gap-2 bg-highlight text-primary px-6 py-3 rounded-lg font-medium hover:bg-highlight/90 transition-colors mb-6 md:mb-12"
          aria-label="Start your contract review"
        >
